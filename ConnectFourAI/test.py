...
if __name__ == '__main__':
	...
	judgeobj.setPlayer1Solver(MCSolver('Player1MC v4', 0.8, 20000, threadcount=8, initialtrycount=8000))
	...
	judgeobj.setPlayer2Solver(MCSolver('Player2MC v4', 0.8, 20000, threadcount=8, initialtrycount=8000))
