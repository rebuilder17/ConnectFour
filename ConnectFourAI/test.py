...
if __name__ == '__main__':
	...
	judgeobj.setPlayer1Solver(MCSolver('Player1MC v5', 0.98, 10000, threadcount=8, initialtrycount=5000))
	...
	judgeobj.setPlayer2Solver(MCSolver('Player2MC v5', 0.98, 10000, threadcount=8, initialtrycount=5000))
